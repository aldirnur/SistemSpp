                  ...
                  <div class="p-4">
                    ...
                    <form class="user" action="/pembayaran" method="get">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="nisn" type="number" value="<?php echo e(old('name')); ?>" placeholder="NISN"> <br>
                            <input class="form-control" id="password" name="pin" type="password" value="<?php echo e(old('pwd')); ?>" placeholder="PIN">
                        </div>
                      <div class="form-group">
                    ...
                    <div class="text-center dont-have"><a href="<?php echo e(route('login')); ?>">Akses Admin</a></div>
                    <hr>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ristiandhii/Downloads/sistem_spp/resources/views/auth/login_siswa.blade.php ENDPATH**/ ?>