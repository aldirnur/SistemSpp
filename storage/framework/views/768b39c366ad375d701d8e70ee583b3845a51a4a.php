<?php $__env->startSection('main-content'); ?>
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"><?php echo e(__('Data Jurusan')); ?></h1>
                    ...
                    <div class="table-responsive">
                        <table id="export-id" class="table table-hover table-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo e($item->jur_id); ?></td>
                                    <td>
                                        <?php echo e($item->nama_jurusan); ?>

                                    </td>
                                    <td>
                                        <div class="actions">
                                            <a onclick="preLoad();" class="btn btn-sm btn-primary shadow-sm"href="<?php echo e(route('edit-jurusan',$item->jur_id)); ?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="<?php echo e(route('add-jurusan')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ristiandhii/Downloads/sistem_spp/resources/views/data_sekolah/Jurusan.blade.php ENDPATH**/ ?>