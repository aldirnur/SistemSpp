                        ...
                        <table id="" class="table table-hover table-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="actions">
                                            <a onclick="preLoad();" class="btn btn-sm bg-success-light" href="{{route('edit-siswa',$item->id_siswa)}}">
                                                <i class="fe fe-pencil"></i> Edit
                                            </a>

                                            <a onclick="preLoad();" class="btn btn-sm bg-danger-light" href="/delete-siswa/{{$item->id_siswa}}">
